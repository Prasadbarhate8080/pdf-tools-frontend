...
import { BadgeCheck, CircleCheck, Gift, InfinityIcon, MousePointerClick, ShieldCheck, SplitIcon, Zap,CheckCircle2, CheckSquare, Check, Sparkles } from "lucide-react";
        ...
        <section className="relative pt-16 pb-6 " style={{ background: 'var(--gradient-hero)' }}>
          ...
          <div className="container pt-16  text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-8 animate-fade-in">
              ...
              Free Online Pdf Page Extracter
            </div>
        ...
        <div>
          ...
          <div className="max-w-7xl flex mx-auto mt-24 flex-wrap gap-10 justify-evenly">
            <FeaturesCard
              ...
              heading={'Easy to Use'}
              paragraph={
                'Design to be simple and intutive to be everyone anyone can be easily use this tool and make his work simple'
              }
            />
            <FeaturesCard
              Icon={Gift}
          ...
          <div className="flex max-w-7xl justify-center md:gap-20 gap-4 items-center flex-wrap mx-auto mt-24 text-gray-800">
            <div className="flex relative w-[370px] h-[300px] md:w-[560px] md:h-[360px] justify-center items-center">
              <Image fill src={'/how_to_merge.png'} alt="how to merge pdf online" />
            </div>
            <div className="flex justify-center items-center">
              <div className="flex flex-col gap-3">
                ...
                <p className="whitespace-pre text-sm tracking-tighter">
                  2. Select Pages which you wnat to extract from the pdf
                </p>
                <p className="whitespace-pre text-sm tracking-tighter">
                  3. Extract pages by pressing extract pages button
                </p>
                <p className="whitespace-pre text-sm tracking-tighter">
                  4. Download extracted pages pdf by pressing download button
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto flex flex-col p-3 mt-12 items-start gap-6">
            <div className="flex flex-col gap-3">
              <p className="text-xl font-semibold text-gray-800">What is the Extract PDF tool?</p>
              <p className="text-sm font-medium text-gray-800">
                Extract PDF allows you to select specific pages from your PDF and download them as a
                new PDF file.
              </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm font-medium text-gray-800">
                Upload your PDF, choose page numbers or ranges like “1-3, 5”, and click on
                “Extract”. Your new PDF will be ready instantly.
              </p>
              <hr className="text-gray-800" />
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm font-medium text-gray-800">
                Yes. Your files are processed securely, and they are removed automatically after
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm font-medium text-gray-800">
                Yes. You can extract pages like “1-3, 5-7, 10” in a single operation and download
                them together.
              </p>
              <hr className="text-gray-800" />
            </div>
            ...
            <div className="flex flex-col gap-3">
              <p className="text-xl font-semibold text-gray-800">Is the Extract PDF tool free?</p>
              <p className="text-sm font-medium text-gray-800">
