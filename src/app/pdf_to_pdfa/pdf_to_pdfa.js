  ...
  return (
    <div className="min-h-screen bg-background">
      {!completionStatus && !isDroped && (
        <ToolHeader sparklesText={"Free Online PDF to PDF/A Converter"} headings={["Convert","PDF to PDF",""]} text={"Create archive-ready PDF/A files in seconds — fast, compliant, and free"}/>
      )}
      <form
        onSubmit={(e) => {
          handleSubmit(e);
