...
import { Document, AddPageWaterMark, pdfjs } from "react-pdf";
import "react-pdf/dist/AddPageWaterMark/AnnotationLayer.css";
import "react-pdf/dist/AddPageWaterMark/TextLayer.css";
        ...
        {isDroped && !isUploading && !isProcessing && !mergeStatus && (
          <div className="max-w-7xl mx-auto p-10">
              ...
              >
                <Document file={file}>
                  <div className="px-4 pt-4 pb-1 flex flex-col items-center justify-center">
                    <AddPageWaterMark pageNumber={1} width={180} />
                  </div>
                </Document>
            ...
            <div className="w-fit mx-auto p-2">
                ...
                <label
                htmlFor="AddPageWaterMark-position"
      ...
      {pageNumberAddedFileURL && (
        <div className="max-w-5xl text-center mx-auto  mt-10">
          <h1 className="text-center text-gray-700 text-3xl font-semibold">
            Download AddPageWaterMark Number Added PDF
          </h1>
