...
export const metadata = {
  ...
  description:
    'PDFtoolify offers a comprehensive suite of free online PDF tools to merge, split, compress, convert, and manage your PDF documents securely and easily.',
  keywords: [
    'PDF tools',
    'merge PDF',
    'split PDF',
  ...
  openGraph: {
    ...
    description:
      'Manage your PDF files with ease. Merge, split, compress, and convert PDFs online for free.',
