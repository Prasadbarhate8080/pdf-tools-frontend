  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="prose prose-blue max-w-none">
        ...
        <p className="text-muted-foreground leading-relaxed mb-4">
          PDF files are more professional than Word documents and are widely used in business and academic settings. By converting your Word documents to PDF, you ensure that your document is presented in a consistent and professional manner.
        </p>

        <h3 className="text-2xl font-semibold mt-8 mb-4 text-foreground">3. Improved Security and Access Control</h3>
        <p className="text-muted-foreground leading-relaxed mb-4">
          PDF files offer more advanced security features than Word documents, such as password protection and digital signatures. This ensures that your sensitive information is kept secure and that only authorized individuals can access or edit your document.
        </p>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Start using our Word to PDF tool today and experience a more professional and consistent way of sharing your digital documents.
        </p>
      </div>
    </div>
  )
