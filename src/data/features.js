...
export const unlockPdfFeatures = [
  ...
  },
  {
    ...
    paragraph:
      'Remove password protection from any PDF — whether it is for reading, copying, or printing — quickly and reliably.',
  },
  {
    icon: BadgeCheck,
...
export const wordToPdfFeatures = [
  {
    icon: MousePointerClick,
    heading: 'Simple & Easy to Use',
    paragraph:
...
export const removePdfPagesFeatures = [
  {
    icon: Scissors,
